...
<form id="cadastro" action="controller/funcionarioController.php" method="post">
    <div class="interno">
        ...
        <!-- Telefone 1 -->
        <div id="campo" class="col-sm-12 col-md-4 offset-md-4 p-1"><input type="text" name="telefone1" class="form-control" placeholder="Digite o telefone"></div>
        <!-- Telefone 2 -->
        <div id="campo" class="col-sm-12 col-md-4 offset-md-4 p-1"><input type="text" name="telefone2" class="form-control" placeholder="Digite o telefone 2"></div>
        <!-- E-mail -->
        ...
        <!-- CPF -->
        <div id="campo" class="col-sm-12 col-md-4 offset-md-4 p-1"><input type="number" name="cpf" class="form-control" placeholder="Digite o CPF"></div>
